...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, "R - B O T  右", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'📑SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'👑OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'🔖SCRIPT'},type:1}
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "R - B O T 右", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'👑OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'command':
 stod = `${sender}`
 listMsg = {
